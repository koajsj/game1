(() => {
  ...
  function shootBullet() {
    ...
    bullet.x = ship.x + (dx / len) * 22;
    bullet.y = ship.y + (dy / len) * 22;
  ...
  function draw() {
    ...
    ctx.rotate(tilt);
    const shipGradient = ctx.createLinearGradient(-22, -20, 20, 22);
    shipGradient.addColorStop(0, '#7af2ff');
    shipGradient.addColorStop(1, '#8cffc1');
